...
しかし、「Full Kit」といっても、図\ref{fig:b_robot_price}のように電装部品も込みというわけではなかった。
商品ページの画像にはいかにも全て揃ってますということを伝えているようにしか思えないためやめていただきたい。
また、購入する場合、タイミングでは円相場と海外手数料について考慮していただきたい。
