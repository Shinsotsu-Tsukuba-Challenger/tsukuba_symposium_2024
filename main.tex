...
\eauthor{○Tatsuhiro IKEBE\authorrefmark{1}、Sora Ebita\authorrefmark{1}、Kenta Haruyama\authorrefmark{1}、Kurumi Osawa\eauthorrefmark{1}\\Kanta Morisita\authorrefmark{1}
Fukaya Kazuya\authorrefmark{1}、Fujie Kenshin\authorrefmark{1}、Shingu Yoshiki\authorrefmark{1}}
